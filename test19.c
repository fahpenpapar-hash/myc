// หาผลรวมและค่าเฉลี่ยของเลข 3 จำนวนที่รันทางแป้นพิมพ์ แล้วแสดงผลออกมา
// input, process (คำนวณ/พิสูจน์ตรวจสอบ/ทำซ้ำ), output, save
// feature การทำงานมีอะไรบ้าง เพ่ื่อมาสรุปเป็นฟังก์ชั่น

// feture  การทำงาน -> รับค่าเฉลี่ยน 3 จำนวน, คำนวณผลรวม, คำนวณหาค่าเฉลี่ย, แสดงผลรวม, แสดงผลค่าเฉลี่ย
// function _> inputNumber, calSum, calAverage, showSumAndAverage
